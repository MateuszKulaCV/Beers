    ...
    <div class="container myrow-container">
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                <form:form id="beerRegisterForm" cssClass="form-horizontal" modelAttribute="beer" method="post" action="savebeers">
    
                    <div class="form-group">
                        <div class="control-label col-xs-3"> <form:label path="name" >Name</form:label> </div>
                        <div class="col-xs-6">
                            <form:hidden path="id" value="${beer.id}"/>
                            <form:input cssClass="form-control" path="name" value="${beer.piwo}"/>
                        </div>
                    </div>
    
                    <div class="form-group">
                        <form:label path="age" cssClass="control-label col-xs-3">pub</form:label>
                        <div class="col-xs-6">
                            <form:input cssClass="form-control" path="age" value="${beerObject}"/>
                        </div>
                    </div>
